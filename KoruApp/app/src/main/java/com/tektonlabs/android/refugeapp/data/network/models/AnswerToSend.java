...
public class AnswerToSend {
    ...
    @Expose
    private String answer_value = null;
    ...
    public AnswerToSend(Answer answer) {
        this.id = answer.getId();

        if(answer.getAnswerValue()!= null && !answer.getAnswerValue().isEmpty()){
            this.answer_value = answer.getAnswerValue();
        }
    }

    public AnswerToSend(String answer_value) {
        this.answer_value = answer_value;
    }
}
