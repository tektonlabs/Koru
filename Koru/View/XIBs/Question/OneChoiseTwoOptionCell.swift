...
import UIKit
protocol OneChoiseTwoOptionCellDelegate: class {
...
class OneChoiseTwoOptionCell: UITableViewCell {
    ...
    weak var delegate: OneChoiseTwoOptionCellDelegate?
    ...
    @IBAction func didTouchOptionYesRadioButton(_ sender: RadioButtonControl) {
        delegate?.oneChoiseTwoOptionCellDidTouchOptionYesRadioButton(cell: self)
    }
    
    @IBAction func didTouchOptionNoRadioButton(_ sender: RadioButtonControl) {
        delegate?.oneChoiseTwoOptionCellDidTouchOptionNoRadioButton(cell: self)
    }
