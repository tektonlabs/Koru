...
refuge = Refuge.create name: "Alamos 2", latitude: "-12.000250", longitude: "-76.847298", country: Country.find_by(name: 'Peru'), city: 'Chosica', address: 'Los Alamos'
  Entity.first_level.each do |entity|
    RefugeEntity.create refuge: refuge, entity: entity
  end

refuge = Refuge.create name: "Alamos Nuevo Horizonte", latitude: "-12.001330", longitude: "-76.846524", country: Country.find_by(name: 'Peru'), city: 'Chosica', address: 'Los Alamos'
  Entity.first_level.each do |entity|
    RefugeEntity.create refuge: refuge, entity: entity
  end

refuge = Refuge.create name: "Santa Rosa", latitude: "-12.004544", longitude: "-76.859146", country: Country.find_by(name: 'Peru'), city: 'Chosica', address: 'Junin'
  Entity.first_level.each do |entity|
    RefugeEntity.create refuge: refuge, entity: entity
  end

refuge = Refuge.create name: "Brisas Manzana A", latitude: "-12.005106", longitude: "-76.864403", country: Country.find_by(name: 'Peru'), city: 'Chosica', address: 'Los Sauces 32'
  Entity.first_level.each do |entity|
    RefugeEntity.create refuge: refuge, entity: entity
  end

refuge = Refuge.create name: "Guadalupe", latitude: "-12.002761", longitude: "-76.867032", country: Country.find_by(name: 'Peru'), city: 'Chosica', address: 'Virgen de Guadalupe'
  Entity.first_level.each do |entity|
    RefugeEntity.create refuge: refuge, entity: entity
  end

refuge = Refuge.create name: "Aliedos de Mañiero", latitude: "-12.003243", longitude: "-76.867143", country: Country.find_by(name: 'Peru'), city: 'Chosica', address: 'El Portillo'
  Entity.first_level.each do |entity|
    RefugeEntity.create refuge: refuge, entity: entity
  end

refuge = Refuge.create name: "Rio 1", latitude: "-12.004723", longitude: "-76.867250", country: Country.find_by(name: 'Peru'), city: 'Chosica', address: 'Piura'
  Entity.first_level.each do |entity|
    RefugeEntity.create refuge: refuge, entity: entity
  end

refuge = Refuge.create name: "Rio 2", latitude: "-12.004838", longitude: "-76.868377", country: Country.find_by(name: 'Peru'), city: 'Chosica', address: 'Piura'
  Entity.first_level.each do |entity|
    RefugeEntity.create refuge: refuge, entity: entity
  end

refuge = Refuge.create name: "Colegio José Faustino Sánchez Carrión", latitude: "-11.999596", longitude: "-76.866409", country: Country.find_by(name: 'Peru'), city: 'Chosica', address: 'El Portillo'
  Entity.first_level.each do |entity|
    RefugeEntity.create refuge: refuge, entity: entity
  end

refuge = Refuge.create name: "Nievería 2a Etapa", latitude: "-12.006527", longitude: "-76.871638", country: Country.find_by(name: 'Peru'), city: 'Chosica', address: 'Prolongación Ramiro Prialé'
  Entity.first_level.each do |entity|
    RefugeEntity.create refuge: refuge, entity: entity
  end

refuge = Refuge.create name: "Av. Los Tulipanes - Chaparral", latitude: "-12.008136", longitude: "-76.881210", country: Country.find_by(name: 'Peru'), city: 'Chosica', address: ''
  Entity.first_level.each do |entity|
    RefugeEntity.create refuge: refuge, entity: entity
  end

refuge = Refuge.create name: "Rio 3", latitude: "-12.009028", longitude: "-76.884481", country: Country.find_by(name: 'Peru'), city: 'Chosica', address: ''
  Entity.first_level.each do |entity|
    RefugeEntity.create refuge: refuge, entity: entity
  end