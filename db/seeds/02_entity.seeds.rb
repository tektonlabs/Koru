...
Entity.create name: "Policías", level: :second_level
Entity.create name: "Serenazgos", level: :second_level
Entity.create name: "Fuerzas armadas", level: :second_level
Entity.create name: "Comité de seguridad", level: :second_level

Entity.create name: "Basureros y puntos de acopio de basura", level: :second_level
Entity.create name: "Recogo de basura", level: :second_level
